...
module.exports.solusiAdd = async (req, res) => {
    ...
    const solusiAdd = [{
            ...
            keterangan: 'Adapun pilihan terapi untuk kelainan refraksi, yaitu kacamata, kontak lensa dan bedah refraktif. Termasuk di dalamnya Laser Assisted In Situ Keratomileusis (Lasik), Trans-PRK, dan Clear lens extraction. Namun kebutuhan mengoreksi kelainan refraksi tergantung dari rules pasien.',
        },
        {
            id: uuid(),
